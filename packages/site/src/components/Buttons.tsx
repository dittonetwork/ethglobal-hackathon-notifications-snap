...
export const SendHelloButton = (props: ComponentProps<typeof Button>) => {
  return <Button {...props}>Connect notifications</Button>;
};

export const SendHelloNotifyButton = (props: ComponentProps<typeof Button>) => {
  return <Button {...props}>Disconnect notifications</Button>;
};

export const GetStateButton = (props: ComponentProps<typeof Button>) => {
  return <Button {...props}>Get notifications state</Button>;
};
